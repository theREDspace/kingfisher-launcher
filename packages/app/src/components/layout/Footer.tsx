...
export function Footer() {
  return (
    <footer className="border-t border-navy/8 bg-white/50 backdrop-blur-md">
      <div className="mx-auto flex max-w-[1180px] flex-wrap items-center justify-center gap-4.5 px-6 pt-6.5 pb-7.5">
        ...
        <div className="flex items-start gap-2">
          <p className="text-xs leading-[1.55] text-muted-foreground-strong">
            <span className="font-bold text-navy">
              Built for development use only.
            </span>{" "}
            This utility is provided on an as-is basis, without warranties or
